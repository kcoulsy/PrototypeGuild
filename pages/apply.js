                ...
                <div className="content">
                    <Panel title="Apply to the guild" styleName="panel-md">
                        <div className="proto-form form-apply">
                            <input name="discordTag" type="text" onChange={this.handleChange}  placeholder="Discord Tag" />
                            <input name="characterName" type="text" onChange={this.handleChange}  placeholder="Character Name" />
                            ...
                            <input name="confirm" type="password"  onChange={this.handleChange} placeholder="Confirm"/>
                            <ReCAPTCHA
                                sitekey="6LcTxaMUAAAAAGRkZQFvvztlW50KYF_QiOVBFwU3"
                                onChange={(val) => this.setState({captcha: val})}
                            />
                            <button className="proto-btn" onClick={this.handleSubmit}>Apply Now</button>
                        </div>
                        {this.state.error}
                    </Panel>
                </div>
